...
void iniSystem(void){
	...
	handlerPWMPin.GPIO_PinConfig.GPIO_PinMode		= GPIO_MODE_OUT;
	...
	handlerPWMPin.GPIO_PinConfig.GPIO_PinAltFunMode	= AF0;
...
//	startPwmSignal(&handlerPWM);
	...
	handlerLEDtimer.TIMx_Config.TIMx_interruptEnable = 1;
